...
import com.yulgnier.common.redis.RedisConfiguration;
...
public class RoomInfoServiceImpl extends ServiceImpl<RoomInfoMapper, RoomInfo>
    ...
    @Autowired
    public RoomInfoServiceImpl(RoomInfoMapper roomInfoMapper, ApartmentInfoMapper apartmentInfoMapper, GraphInfoMapper graphInfoMapper, FacilityInfoMapper facilityInfoMapper, LabelInfoMapper labelInfoMapper, PaymentTypeMapper paymentTypeMapper, FeeValueMapper feeValueMapper, LeaseTermMapper leaseTermMapper, BrowsingHistoryService browsingHistoryService, RedisTemplate<String, Object> redisTemplate) {
    ...
    public RoomDetailVo getRoomDetailVoById(Long id) {
        ...
        if (roomDetailVo == null) {
            ...
            redisTemplate.opsForValue().set(key, roomDetailVo); //缓存
        }
        //保存浏览历史
